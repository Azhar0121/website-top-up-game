    ...
    <div class="container py-5" style="max-width: 460px;">
        ...
        <div class="checkout-panel">
            ...
            <form action="{{ route('login.submit') }}" method="POST" novalidate id="login-form">
                ...
                <button type="submit" class="btn app-btn-cta w-100" id="login-submit-btn">Masuk</button>
            </form>
...
<script>
    (function () {
        ...
        form.addEventListener('submit', function (event) {
            // Kalau reCAPTCHA belum dikonfigurasi (siteKey kosong), langsung submit seperti biasa.
            ...
            grecaptcha.ready(function () {
                grecaptcha.execute(siteKey, { action: 'login' }).then(function (token) {
                    ...
                    form.submit(); // fallback: tetap submit biar user tidak stuck kalau reCAPTCHA error
                });
            });
        });
    })();
