...
class OrderController extends Controller
{
    public function store(Request $request, VoucherService $voucherService)
    {
        ...
        // stock NULL berarti produk unlimited (lihat komentar di OrderService::decrementStock),
        // jadi validasi ini cuma berlaku kalau admin sengaja set angka stok terbatas.
